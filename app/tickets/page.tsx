...
export default function RSVPPage() {
  ...
  const handleDietaryChange = (
    ...
    setFormData((prev) => {
      ...
      if (isOther && otherValue) {
        updatedRestrictions = [
          ...currentRestrictions.filter((r) => !r.startsWith("Other:")),
          `Other: ${otherValue}`,
        ];
  ...
  const validateForm = () => {
    ...
    if (allGuests.length > 0) {
      const guestsWithoutDietaryInfo = allGuests.filter(
        (guest) =>
          !formData.dietaryRestrictions[guest.key] ||
          formData.dietaryRestrictions[guest.key].length === 0
      );
      if (guestsWithoutDietaryInfo.length > 0) {
        newErrors.dietaryRestrictions =
          'Please select dietary restrictions for all guests (select "None" if no restrictions)';
      }
    }
    ...
    if (!formData.mailingAddress.name.trim())
      newErrors.addressName = "Name is required";
    ...
    if (!formData.mailingAddress.zip.trim())
      newErrors.addressZip = "ZIP/Postal code is required";
  ...
  return (
    <main className="relative min-h-screen">
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #ff0099, #ff6600, #ffcc00, #22cc88, #00ccff, #cc88ff, #ff0099)",
      ...
      <div className="relative z-10">
            ...
            <div className="h-28 sm:h-32 md:h-40 flex items-center">
              ...
              >
                ...
                <div
                  ...
                  style={{ gap: "var(--gap)", paddingLeft: "var(--pad)" }}
                >
                ...
                >
                  <h1
                    ...
                    style={{
                      fontFamily:
                        "'ZollaPro','Impact','Arial Black',sans-serif",
                      color: "#d81b8c",
                ...
                <div
                  ...
                  style={{ gap: "var(--gap)", paddingRight: "var(--pad)" }}
                >
        ...
        <div
          className="px-4 pb-12 mt-6 sm:mt-8 md:mt-10 lg:mt-12"
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border-2 border-white/20 mb-8">
              ...
              >
                <div style={{ color: "#000" }}>
                  <strong>Friday, January 16th: The Pregame</strong> -{" "}
                  <em>Welcome drinks & games on the beach!</em>
                </div>
                <div style={{ color: "#000" }}>
                  <strong>Saturday, January 17th: The Main Stage</strong> -{" "}
                  <em>Dance & celebrate with us all night!</em>
                </div>
                <div style={{ color: "#000" }}>
                  <strong>Sunday, January 18th: The Aftershow</strong> -{" "}
                  <em>Final celebration...on a boat!</em>
                </div>
              </div>
            </div>
            ...
            {submitStatus === "error" && (
              <div className="mb-6 p-4 bg-red-500/20 border-2 border-red-400/50 rounded-xl text-center">
                ...
                >
                  ...
                  again or email us at info@bremmiepalooza.com
                </p>
              </div>
            )}
            ...
            >
                ...
                <div className="mb-8">
                  ...
                  >
                    ...
                    <span className="text-sm font-normal">
                      {" "}
                      (Select {formData.passType === "1-Day" ? "1" : "2"} event
                      {formData.passType === "2-Day" ? "s" : ""})
                    </span>
                  </label>
                  <div className="space-y-3">
                    {events.map((event) => (
                ...
                <>
                  ...
                  {formData.numKids && (
                    <div className="mb-8">
                      ...
                      <div className="space-y-3">
                        {Array.from(
                          { length: parseInt(formData.numKids) },
                          (_, index) => (
                            <input
                              key={index}
                              type="text"
                          ...
                          {attendingEvents.map((event) => (
                            ...
                            >
                              <input
                                ...
                                value={event.id}
                                checked={formData.babysittingEvents.includes(
                                  event.id
                                )}
                                onChange={handleInputChange}
                                className="mr-3 w-5 h-5"
                    ...
                    {getAllGuests().map((guest) => (
                      <div key={guest.key} className="bg-white/5 rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                          {dietaryOptions.map((option) => (
                            ...
                            >
                              <input
                                ...
                                onChange={() =>
                                  handleDietaryChange(guest.key, option)
                                }
                          ...
                          {(formData.dietaryRestrictions[guest.key] || []).some(
                        ...
                        {(formData.dietaryRestrictions[guest.key] || [])
                          ...
                          <div className="flex flex-wrap gap-2 mt-3">
                            {(formData.dietaryRestrictions[guest.key] || []).map(
                              (restriction) => (
                                <span
                                  key={restriction}
                                  className="bg-pink-500/30 text-white px-2 py-1 rounded text-sm flex items-center"
                                >
                                  {restriction}
                                  <button
                                    type="button"
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  />
                  {errors.addressName && (
                    <p className="text-red-600 bg-white/90 px-3 py-2 rounded-lg mt-2 font-semibold md:col-span-2">
                      {errors.addressName}
                    </p>
                  )}
                  <input
              ...
              <div className="text-center pt-8">
                ...
                {Object.keys(errors).length > 0 && (
                  <div className="mt-6">
                    <p
                      className="text-red-600 bg-white/90 px-4 py-3 rounded-lg font-semibold text-lg"
                      style={{ fontFamily: "Arial, sans-serif" }}
                    >
      ...
      <div
        className="fixed left-0 w-full bottom-0 z-10"
